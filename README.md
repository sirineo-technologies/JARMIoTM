...
de baixo custo, bem como para aplicações mais voltadas para aprendizagem. Abaixo a primeira versão da JARM IoT M, a versão atual e a versão sem alguns recursos do hardware.
